                                        ...
                                        <tr style="border-collapse:collapse">
                                            <td align="center"
                                                ...
                                                <p
                                                    ...
                                                    <strong>FORMATO SOLICITUD DE PERSONAL</strong>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            ...
                                                            <td
                                                                ...
                                                                &nbsp; {{$solicitud->rel_usuario_creador->areas[0]->nombreAreas->nombre}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                            ...
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->rel_usuario_creador->name}}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td align="left"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            ...
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{date('d-m-Y h:i:s a',strtotime($solicitud->created_at))}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                <strong>Fecha Inducción: </strong>
                                                            </td>
                                                            <td
                                                                style="padding:0;Margin:0;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:14px;line-height:21px">
                                                                &nbsp; {{date('d-m-Y',strtotime($solicitud->induction_date))}}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr
                                                                                                        ...
                                                                                                        <td align="left"
                                                                                                            ...
                                                                                                            <p
                                                                                                                style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:rgb(255, 255, 255);font-size:14px">
                                                                                                                Especificaciones de la Vacante
                                                                                                            </p>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                ...
                                                <td align="left"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            ...
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->rel_cliente->rel_ciudad->nombre}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                            ...
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->rel_cliente->rel_localidad->name}}
                                                            </td>
                                                            <tr style="border-collapse:collapse">
                                                                <td
                                                                    style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                ...
                                                                <td
                                                                    style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                    &nbsp; {{$solicitud->rel_cliente->rel_barrio->name}}
                                                                </td>
                                                            </tr>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td align="left"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            ...
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->programming}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                <strong>Motivo de la Vacante</strong>:
                                                            </td>
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->rel_tipo_vacante->name}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                            ...
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->rel_tipo_contrato->name}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                <strong>Salario (Valor por el que cotiza)</strong>:
                                                            </td>
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; ${{number_format($solicitud->salary_to_quote)}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                <strong>Salario a Devengar</strong>:
                                                            </td>
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; ${{number_format($solicitud->salary_to_accrue)}}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td align="left"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                <strong>Cantidad de Unidades (F)</strong>:
                                                            </td>
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->units_female}}
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                <strong>Cantidad de Unidades (M)</strong>:
                                                            </td>
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{$solicitud->units_female}}
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td align="left"
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;width:100px">
                                                                <strong>Rango de Edad</strong>:
                                                            </td>
                                                            <td
                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                &nbsp; {{str_replace(';',' a ',$solicitud->age_range)}} años
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td
                                                                            ...
                                                                            <div id="main_content_wrap"
                                                                                ...
                                                                                <section
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <h5
                                                                                            style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;color:#303c54">
                                                                                            Firma Solicitante :
                                                                                        </h5>
                                                                                        <img draggable="false"
                                                                                            src="{{ asset('image/users/firmas/'.$solicitud->rel_usuario_creador->signature) }}"
                                                                                            width="200"
                                                                                    ...
                                                                                    <div id="main_content_wrap"
                                                                                        ...
                                                                                        <section
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <img draggable="false"
                                                                                                    src="{{ asset(($solicitud->state == 1)?'image/users/firmas/'.$solicitud->rel_usuario_creador->signature:'image/users/firmas/tu_firma_aqui.jpg') }}"
                                                                                                    width="200"
                                                                                                    style="margin-top: 10px;">
                                                                                                    <h5
                                                                                                    style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;color:#303c54">
                                                                                                    {{($solicitud->state == 1)?date('d-m-Y h:i:s a',strtotime($solicitud->updated_at)):''}}
                                                                                                </h5>
                                                                                                </div>
                                                                                            </section>
                                                                                        </div>
