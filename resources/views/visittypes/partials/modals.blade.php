        ...
        <div class="modal-content">
            <form id="form_crear" data-toggle="validator" role ="form">
                <div style="background: #303c54;" class="modal-header">
                    <h5 class="modal-title text-white">Agregar Tipo de Visita</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text" name="module" id="module" class="form-control" placeholder="Módulo" required>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="form_actualizar" data-toggle="validator" role ="form" enctype="multipart/form-data">
                <div style="background: #303c54;" class="modal-header">
                    <h5 style="color: #FFF" class="modal-title">Actualizar Tipo de Visita</h5>
                    <button type="button" class="close text-light" data-dismiss="modal" aria-label="Cerrar">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                <label for="module_edit">Módulo</label>
                                <input type="text" name="module_edit" id="module_edit" class="form-control" placeholder="Módulo" required>
                            </div>
                        </div>
                    </div>
                </div>
