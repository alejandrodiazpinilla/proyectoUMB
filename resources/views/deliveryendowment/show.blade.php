...
<head>
    ...
    <title>{{ $dotacion->type }} de Dotación | {{ $dotacion->rel_guarda->name }}</title>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="right" class="es-infoblock"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:14px;color:#CCCCCC;font-size:12px">
                                                                        {{$dotacion->type == 'Entrega' ? 'Entrega' : 'Devolución'}} de Dotación</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>ENTREGA / DEVOLUCIÓN DE DOTACIÓN <br>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <h4
                                                                        ...
                                                                        {{ $dotacion->type == 'Devolución' ? 'Quien
                                                                        Entrega' : 'Quien Recibe'}}:</h4>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            ...
                                                                            <td
                                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                                &nbsp; {{
                                                                                $dotacion->rel_funcionario->email }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                            ...
                                                                            <td
                                                                                style="padding:0;Margin:0;font-size:14px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif">
                                                                                &nbsp; {{
                                                                                $dotacion->rel_funcionario->cargo }}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <p
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <table class="es-footer-body"
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="Margin:0;padding-top:10px;padding-bottom:10px;padding-left:20px;padding-right:20px;background-color:#d2eef7"
                                                                                align="left">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td style="padding:0;Margin:0">
                                                                    <table
                                                                        ...
                                                                        @foreach ($dotacion->rel_dotacion_prendas as $dot)
                                                                        <tr
                                                                                                ...
                                                                                                <section id="main_content" class="inner">
                                                                                                    <div style="text-align: center">
                                                                                                        <h5 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;color:#303c54">
                                                                                                            {{$dotacion->type == 'Devolución' ? 'Firma Quien Entrega' : 'Firma Quien Recibe'}}:
                                                                                                        </h5>
                                                                                                        <img draggable="false" src="{{ asset('image/firmasDotacion/'.$dotacion->guard_signature) }}" width="200" style="margin-top: 10px;">
                                                                                                    </div>
                                                                                                </section>
                                                                                            </div>
                                                                                        </td>
                                                                                            ...
                                                                                            <div id="main_content_wrap" class="outer m-portlet__foot mx-auto mb-3">
                                                                                                <section id="main_content" class="inner">
                                                                                                    <div style="text-align: center">
                                                                                                        <h5
                                                                                                            style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;color:#303c54">
                                                                                                            {{$dotacion->type == 'Entrega' ? 'Firma Quien Entrega' : 'Firma Quien Recibe'}}:
                                                                                                        </h5>
                                                                                                        <img draggable="false" src="{{ asset('image/firmasDotacion/'.$dotacion->official_signature) }}" width="200" style="margin-top: 10px;">
                                                                                                    </div>
                                                                                                </section>
                                                                                            </div>
                                                                                        </td>
