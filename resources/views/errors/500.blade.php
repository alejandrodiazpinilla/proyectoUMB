...
<body>
    <main>
        <div>
            <div>
                <span style="text-decoration: underline;">Error&nbsp;500</span>
                <span>Error&nbsp;Interno&nbsp;del&nbsp;Servidor&nbsp;<br>del&nbsp;Protocolo&nbsp;de&nbsp;Transferencia&nbsp;de&nbsp;Hipertexto,<br>&nbsp;el&nbsp;servidor&nbsp;encontró&nbsp;una&nbsp;condición&nbsp;<br>inesperada&nbsp;que&nbsp;le&nbsp;impide&nbsp;completar&nbsp;la&nbsp;petición.</span>
            </div>
        ...
        <div>
            ...
            <div>
                <span>Por&nbsp;favor,&nbsp;regrese&nbsp;a&nbsp;la&nbsp;interfaz&nbsp;de&nbsp;Usuario</span>
                <span>
                    <a href="{{ route('home') }}" style="text-decoration: none;color:#fff">
                        <b>Ir&nbsp;al&nbsp;inicio</b>
                    </a>
                    <a onclick="history.back(-1)" style="text-decoration: none;color:#fff">
                        <b>Regresar</b>
                    </a>
                </span>
            </div>
