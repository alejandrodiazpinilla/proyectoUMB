        ...
        <div class="modal-content">
            <form id="form_crear" data-toggle="validator" role ="form">
                <div style="background: #303c54;" class="modal-header">
                    <h5 class="modal-title text-white">Agregar Tipo de Documento</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text" name="abreviacion" id="abreviacion" class="form-control" placeholder="Abreviación" required>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-group">
                                <label for="categoria">Categoría</label>
                                {{ Form::select('categoria', $categorias, null, ['class'=> 'form-control m-select2', 'id'=>'categoria', 'required' => 'true', 'placeholder' => 'Seleccione...', 'style'=>'width:100%;']) }}
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="form_actualizar" data-toggle="validator" role ="form" enctype="multipart/form-data">
                <div style="background: #303c54;" class="modal-header">
                    <h5 class="modal-title text-white">Actualizar Tipo de Documento</h5>
                    <button type="button" class="close text-light" data-dismiss="modal" aria-label="Cerrar">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                <label for="abreviacion_edit">Abreviación</label>
                                <input type="text" name="abreviacion_edit" id="abreviacion_edit" class="form-control" placeholder="Abreviación" required>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-group">
                                <label for="categoria_edit">Categoría</label>
                                {{ Form::select('categoria_edit', $categorias, null, ['class'=> 'form-control m-select2', 'id'=>'categoria_edit', 'required' => 'true', 'placeholder' => 'Seleccione...', 'style'=>'width:100%;']) }}
                            </div>
                        </div>
                    </div>
                </div>
