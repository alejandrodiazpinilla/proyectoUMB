...
return new class extends Migration
{
    public function up()
    {
        Schema::create('employees_affiliations', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('affiliation_id')->references('id')->on('affiliations')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('employees_affiliations');
    }
};
